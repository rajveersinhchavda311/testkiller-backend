...
INSERT INTO questions (id, question_text, question_type, subject_id, topic, difficulty, marks, negative_marks, explanation, tags, correct_answer, created_at, updated_at) VALUES
  ...
  (2, 'Which of the following are Spring stereotype annotations?',  'MULTIPLE_CHOICE', 2, 'Annotations', 'MEDIUM', 2, 0.5, '@Component and @Service are stereotypes; @Entity is JPA.',            'spring,annotations',  NULL, NOW(6), NOW(6)),
